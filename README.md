...
### Events
- Select option: Action to trigger when an option is selected. This flow can have the context object and the object returned by the datasource as parameter.
- Deselect option: Action to trigger when an option is deselected. This flow can have the context object and the object returned by the datasource as parameter.
- Clear all: Action to trigger when an option is deselected. This flow can have the context object and the object returned by the datasource as parameter.
